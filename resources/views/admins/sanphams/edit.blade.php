                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ma_san_pham" name="ma_san_pham" class="form-control
                                                @error('ma_san_pham') is-invalid @enderror" value="{{ $sanPham->ma_san_pham }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="so_luong" name="so_luong" class="form-control
                                                @error('so_luong') is-invalid @enderror" value="{{ $sanPham->so_luong }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="ngay_nhap" name="ngay_nhap" class="form-control
                                                @error('ngay_nhap') is-invalid @enderror" value="{{ $sanPham->ngay_nhap }}">
                                            @error('ngay_nhap')
                                                <p class="text text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img src="{{ Storage::url($sanPham->hinh_anh)}}" id="img_danh_muc" alt="Hình ảnh sản phẩm"
                                                style=" width : 150px; ">
                                        </div>

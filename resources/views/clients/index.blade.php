                                    ...
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img" src="{{Storage::url($value->hinh_anh)}}" alt="product">
                                                    <img class="sec-img" src="{{Storage::url($value->hinh_anh)}}" alt="product">
                                                </a>
                                            ...
                                            <div class="product-caption text-center">
                                                ...
                                                <div class="price-box">
                                                    <span class="price-regular">{{number_format($value->gia_khuyen_mai,0, '-', '.')}} VND</span>
                                                    <span class="price-old"><del>{{number_format($value->gia_san_pham,0, '-', '.')}} VND</del></span>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
